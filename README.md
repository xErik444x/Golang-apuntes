...
- [Empecemos con lo bueno, se vienen los JSONs!](09_json/README.md#empecemos-con-lo-bueno-se-vienen-los-jsons)
	- [¿Qué es un JSON? te estarás preguntando... o no (?)](09_json/README.md#qué-es-un-json-te-estarás-preguntando-o-no-)
	- [¿Cómo se utiliza este formato en Go?](09_json/README.md#cómo-se-utiliza-este-formato-en-go)
		- [Manejo de Estructuras Anidadas](09_json/README.md#manejo-de-estructuras-anidadas)
		- [Etiquetas!](09_json/README.md#etiquetas)
		- [Recomendación NO SALTAR!](09_json/README.md#recomendación-no-saltar)
- [Interfaces y Tipos!](10_interfaces/README.md#interfaces-y-tipos)
  - [¿Que es una interface?](10_interfaces/README.md#que-es-una-interface)
    - [Conceptos rápidos a tener en cuenta:](10_interfaces/README.md#conceptos-rápidos-a-tener-en-cuenta)
    - [Ejemplo básico de interfaz](10_interfaces/README.md#ejemplo-básico-de-interfaz)
  - [Usando interfaces en funciones como parámetros](10_interfaces/README.md#usando-interfaces-en-funciones-como-parámetros)
  - [Interfaces vacías](10_interfaces/README.md#interfaces-vacías)
  - [Type assertions](10_interfaces/README.md#type-assertions)
- [Goroutines, Concurrencia y Canales!](11_goroutines/README.md#goroutines-concurrencia-y-canales)
  - [¿Qué es la concurrencia?](11_goroutines/README.md#qué-es-la-concurrencia)
  - [¿Qué es una Goroutine?](11_goroutines/README.md#qué-es-una-goroutine)
    - [¿Cuales son las ventajas de usar Goroutines?](11_goroutines/README.md#cuales-son-las-ventajas-de-usar-goroutines)
    - [Iniciando una Goroutine](11_goroutines/README.md#iniciando-una-goroutine)
  - [Canales!](11_goroutines/README.md#canales)
    - [Creando un canal](11_goroutines/README.md#creando-un-canal)
    - [Enviando y Recibiendo Datos](11_goroutines/README.md#enviando-y-recibiendo-datos)
    - [Ejemplo de código completo](11_goroutines/README.md#ejemplo-de-código-completo)